        ...
        grid = $.addGrid("#grid",
                {
                    ...
                    cols: [
                        {display: 'NO.', name: '_NUM_', width: 40, align: 'left'},
                        						{display: 'NOMBRE', name: 'nombre', width: 400, align: 'left'},
   ...
   <form class="div-form-busqueda ui-dialog-content ui-widget-content" id="form-busqueda">
        <div style="width:100%; margin:auto">
            ...
            <tr> 
                ...
                <td class="tdc">:</td>
                <td class="tdd">
                    <input type="text" id="bnombre" name="nombre" title="Nombre" placeholder="Nombre" maxlength="255" value="" />
                </td>            
            </tr>
            </table>
            <div class="acciones"> 
      ...
      <div class="modal-body">
          ...
          <form id="formulario">
            ...
            <tr> 
                ...
                <td class="tdc">:</td>
                <td class="tdd">
                    <input type="text" id="nombre" name="nombre" title="Nombre" placeholder="Nombre" maxlength="255" value="" />
                </td>            
            </tr>
            </table>
          </form>
