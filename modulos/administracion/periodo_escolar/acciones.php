...
class Periodo_escolar extends formulario_basico {

    function validar() {
        $v = new Validation($_POST);
		$v->addRules('nombre', 'Nombre', array('required' => true, 'maxLength' => 255) );
    ...
    function getSQL() {
        ...
        $sql = "SELECT * FROM periodo_escolar WHERE 1=1  $s ORDER BY id ASC ";
        return $sql;
    }
...
$accion = ACCION;
$f = new Periodo_escolar("periodo_escolar", "id", true);
$f->$accion();
?>