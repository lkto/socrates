        ...
        grid = $.addGrid("#grid",
                {
                    ...
                    cols: [
						...
						{display: 'AREA', name: 'area', width: 300, align: 'left'},
						{display: 'CURSO', name: 'curso', width: 300, align: 'left'},
...
<div class="container-fluid">
   ...
   <form class="div-form-busqueda ui-dialog-content ui-widget-content" id="form-busqueda">
        <div style="width:100%; margin:auto">
            ...
            <tr>
                <td class="tdi">Areas</td>
                <td class="tdc">:</td>
                <td class="tdd">
                	<select id="bareas" name="areas" title="Areas">
                    	<?php llenar_combo("SELECT id, nombre FROM areas ORDER BY nombre",true); ?>
                    </select>                
                </td>
            </tr> 
            <tr>
                <td class="tdi">Curso</td>
                <td class="tdc">:</td>
                <td class="tdd">
                	<select id="bcurso" name="curso" title="Curso">
                    	<?php llenar_combo("SELECT id, nombre FROM cursos ORDER BY nombre",true); ?>
                    </select>                
                </td>
            </tr>
            </table>
      ...
      <div class="modal-body">
          ...
          <form id="formulario">
            ...
            <tr>
                ...
                <td class="tdc">:</td>
                <td class="tdd">
                	<select id="areas" name="areas" title="Areas">
                    	<?php llenar_combo("SELECT id, nombre FROM areas ORDER BY nombre",true); ?>
                    </select>                
                </td>
            </tr> 
