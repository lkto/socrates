        ...
        <div class="row">
            <div class="col-lg-4 col-sm-12">
                <form class="card auth_form">
                    <div class="header">
                        <img class="logo" src="<?php echo WEB_ROOT ?>plantilla/assets//images/logo.svg" alt="">
                        <h5>Error 404</h5>
                        <span>Upps! no se encontró la página que estás buscando.</span>
                    </div>
                    <div class="body">
                        <a href="iniciar-sesion" class="btn btn-primary btn-block waves-effect waves-light">Regresar</a>                        
                    </div>
                </form>
            ...
            <div class="col-lg-8 col-sm-12">
                <div class="card">
                    <img src="<?php echo WEB_ROOT ?>plantilla/assets//images/404.svg" alt="404" />
                </div>
            </div>
        </div>
    </div>
